...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("https://trucks-vistoria-app.vercel.app", "https://trucks-vistoria-issiyvb7g-weslleysoaresms-projects.vercel.app") // Permite Vercel, localhost, etc.
